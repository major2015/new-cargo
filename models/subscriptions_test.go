...
var (
	subscriptionDBTypes = map[string]string{`ID`: `integer`, `SubscriptionID`: `character varying`, `Name`: `character varying`, `Description`: `character varying`, `Price`: `numeric`, `TrialDuration`: `integer`}
	_                   = bytes.MinRead
)
