...
var TenantWhere = struct {
	...
	HomepageURL    whereHelpernull_String
	...
	SubscriptionID: whereHelperint{field: "\"tenants\".\"subscription_id\""},
	LogoURL:        whereHelpernull_String{field: "\"tenants\".\"logo_url\""},
	HomepageURL:    whereHelpernull_String{field: "\"tenants\".\"homepage_url\""},
	Email:          whereHelperstring{field: "\"tenants\".\"email\""},
	Metadata:       whereHelpernull_JSON{field: "\"tenants\".\"metadata\""},
...
var (
	tenantAllColumns            = []string{"id", "identifier", "name", "subscription_id", "logo_url", "homepage_url", "email", "metadata", "created_at", "updated_at"}
...
func (tenantL) LoadSubscription(e boil.Executor, singular bool, maybeTenant interface{}, mods queries.Applicator) error {
	...
	query := NewQuery(
		...
		qm.WhereIn(`subscriptions.id in ?`, args...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
func (o *Tenant) Update(exec boil.Executor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return 0, errors.New("cargo_db: unable to update tenants, could not build whitelist")
		}
	...
	if err != nil {
		return 0, errors.Wrap(err, "cargo_db: unable to update tenants row")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "cargo_db: failed to get rows affected by update for tenants")
	}
...
func (q tenantQuery) UpdateAll(exec boil.Executor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "cargo_db: unable to update all for tenants")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "cargo_db: unable to retrieve rows affected for tenants")
	}
...
func (o TenantSlice) UpdateAll(exec boil.Executor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "cargo_db: unable to update all in tenant slice")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "cargo_db: unable to retrieve rows affected all in update all tenant")
	}
	return rowsAff, nil
}
...
func (o *Tenant) Delete(exec boil.Executor) (int64, error) {
	if o == nil {
		return 0, errors.New("cargo_db: no Tenant provided for delete")
	}
	...
	result, err := exec.Exec(sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "cargo_db: unable to delete from tenants")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "cargo_db: failed to get rows affected by delete for tenants")
	}
...
func (q tenantQuery) DeleteAll(exec boil.Executor) (int64, error) {
	if q.Query == nil {
		return 0, errors.New("cargo_db: no tenantQuery provided for delete all")
	}
	...
	result, err := q.Query.Exec(exec)
	if err != nil {
		return 0, errors.Wrap(err, "cargo_db: unable to delete all from tenants")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "cargo_db: failed to get rows affected by deleteall for tenants")
	}
...
func (o TenantSlice) DeleteAll(exec boil.Executor) (int64, error) {
	...
	result, err := exec.Exec(sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "cargo_db: unable to delete all from tenant slice")
	}
